...
When the causal variable of interest depends in some way on the unobservables, we say that the determination of $X$ is **endogenous**. You will often then see these biases referred to as problems with  **endogeneity**.
...
$$  U(C,H) = C - \alpha_{n}\frac{H^{1+1/\psi}}{1+1/\psi},\ C = WH $$
...
Let $\alpha_{n}=\alpha$ (no OVB), but:
  $$  U(C,H) = C - \alpha\frac{H^{1+1/\psi}}{1+1/\psi} - \Omega\mathbf{1}\{H>0\} $$
