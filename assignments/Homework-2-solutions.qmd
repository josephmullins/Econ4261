...
The model is:
$$ \mathbb{E}[\log(Wage)|Age_{n},kids_{n},F_{n} ] = \beta_{0} + \beta_{1}F_{n} + \beta_{2}kid_{n} + \beta_{3}kids_{n}F_{n} + \beta_{4}Age_{n} + \beta_{5}Age_{n}F_{n} + \beta_{6}Age_{n}kids_{n} + \beta_{6}Age_{n}F_{n}kids_{n} $$
